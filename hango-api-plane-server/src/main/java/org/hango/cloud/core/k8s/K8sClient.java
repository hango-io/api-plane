...
public class K8sClient {
    ...
    public ConfigMap getConfigMap(String namespaces, Map<String, String> labels){
        List<ConfigMap> items = client.configMaps().inNamespace(namespaces).withLabels(labels).list().getItems();
