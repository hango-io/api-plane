...
import me.snowdrop.istio.api.networking.v1alpha3.WorkloadEntrySpec;
...
public class ServiceEntryOperatorTest {
    ...
    public void testMerge() {
        ...
        List<WorkloadEntrySpec> gw1 = filterByGwLabel(spec.getEndpoints(), "gw1");
        ...
        List<WorkloadEntrySpec> gw2 = filterByGwLabel(spec.getEndpoints(), "gw2");

        Assert.assertEquals(1, gw2.size());
        Assert.assertEquals("test.c", gw2.get(0).getAddress());

        List<WorkloadEntrySpec> gw3 = filterByGwLabel(spec.getEndpoints(), "gw3");

        Assert.assertEquals(1, gw3.size());
        Assert.assertEquals("test.f", gw3.get(0).getAddress());

        List<WorkloadEntrySpec> gw4 = filterByGwLabel(spec.getEndpoints(), "gw4");
    ...
    private List<WorkloadEntrySpec> filterByGwLabel(List<WorkloadEntrySpec> endpoints, String gateway) {
